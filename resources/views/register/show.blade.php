            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                ...
                <div class="block block-themed animated fadeIn">
                    ...
                    <div class="block-content block-content-full block-content-narrow">
                        <!-- Register Title -->
                        <h1 class="h2 font-w600 push-30-t push-5">Squad Locker</h1>
                        <p>Please fill the following details to create a an account.</p>
                        <!-- END Register Title -->
                        ...
                        <form class="js-validation-register form-horizontal push-50-t push-50" action="base_pages_register.html" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="form-material form-material-success">
                                        <input class="form-control" id="register-password2" name="xbox-gamertag" placeholder="Enter your XBOX Gamertag">
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="form-material form-material-success">
                                        <input class="form-control" id="register-password2" name="ps4-gamertag" placeholder="Enter your PS4 Gamertag">
