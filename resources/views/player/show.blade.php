                    ...
                    <div class="bg-black-op">
                        <div class="block block-themed block-transparent play-style-height">
                            ...
                            <div class="block-content block-content-full text-center" id="bg-block-content">
                                ...
                                <div class="row">
                                    <div class="rep-rating center content content-boxed">
                                        <div class="row clearfix pull-t">
                                            <span class="h4 font-w700 pull-right corner-push">95 OVR</span>
                                            <span class="h4 text-muted pull-left corner-push">REP</span>
                                        </div>
                                        <div class="row clearfix pull-t">
                                            <div class="progress">
                ...
                <div class="content-grid">
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="block block-themed">
                                    <div class="block-header bg-success sm-padding">
                                        <h3 class="block-title">PER</h3>
                                    </div>
                                    <div class="block-content sm-padding">
                                        <span class="label label-success clear label-margin label-shrink">+3</span>
                                        <div class="h3 text-success center grademargin extra-pad-vert font-w700 text-success" data-toggle="countTo" data-to="28.2">28.2</div>
                                    </div>
                                ...
                                <div class="block block-themed">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <h3 class="text-success center grademargin extra-pad-vert">.625%</h3>
                                    </div>
                                    <div class="row text-center font-s13">
                                        <div class="col-xs-6">
                                            <a class="font-w600 text-gray-dark" href="javascript:void(0)">
                            ...
                            <div class="col-xs-3">
                                <div class="block block-themed">
                                    <div class="block-header bg-warning sm-padding">
                                        <h3 class="block-title">APG</h3>
                                    </div>
                                    <div class="block-content sm-padding">
                                        <span class="label label-warning clear label-margin label-shrink">
                                            <i class="fa fa-refresh fa-spin"></i>
                                        </span>
                                        <h3 class="text-warning center grademargin extra-pad-vert">2.4</h3>
                                    </div>
                                    <div class="row text-center font-s13">
                                        <div class="col-xs-6">
                                            <a class="font-w600 text-gray-dark" href="javascript:void(0)">
                                ...
                                <div class="block block-themed">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <h3 class="text-danger center grademargin extra-pad-vert">1:2</h3>
                                    </div>
                                    <div class="row text-center font-s13">
                                        <div class="col-xs-6">
                                            <a class="font-w600 text-gray-dark" href="javascript:void(0)">
                            ...
                            <div class="col-xs-3">
                                <div class="block block-themed">
                                    <div class="block-header bg-success sm-padding">
                                        <h3 class="block-title">PPG</h3>
                                    </div>
                                    <div class="block-content sm-padding">
                                        <span class="label label-success clear label-margin label-shrink">+1</span>
                                        <h3 class="text-success center grademargin extra-pad-vert">7.5</h3>
                                    </div>
                                    <div class="row text-center font-s13">
                                        <div class="col-xs-6">
                                            <a class="font-w600 text-gray-dark" href="javascript:void(0)">
