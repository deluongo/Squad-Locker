                            ...
                            <div class="tab-pane fade fade-left" id="tabs-side-overlay-sales">
                                <div class="block pull-r-l">
                                    ...
                                    <div class="twitter-scroll">
                                        <a class="twitter-timeline" data-theme="light" data-link-color="#2B7BB9" href="@if(!is_null(Auth::user()->players->first())) {{Auth::user()->players->first()->twitter}} @else https://twitter.com/devonluongo @endif">Tweets by {{Auth::user()->name}}</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
                                    </div>
